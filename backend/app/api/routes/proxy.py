...
async def validate_url(url: str) -> str:
    ...
    try:
        ...
        # Resolve hostname to check if it points to a private IP (SSRF protection)
        try:
            ...
            # If resolution fails, we could block or allow.
            # Blocking is safer, but might block valid domains with temporary DNS issues.
            # However, if we can't resolve it, we can't fetch it anyway.
            # But httpx might resolve it differently? Unlikely.
            pass
