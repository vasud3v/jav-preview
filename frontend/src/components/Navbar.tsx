...
import { Search, Menu, X, Home, Calendar, Grid3X3, Users, Building2, Film, User, LogOut, Settings, Bookmark } from 'lucide-react';
                ...
                <div className="relative group">
                  ...
                  >
                    <button
                      ...
                      className="w-full px-4 py-2.5 text-sm text-left text-foreground rounded-t-lg transition-colors cursor-pointer"
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor = `rgba(${color.rgb}, 0.1)`;
                        e.currentTarget.style.color = color.hex;
                      }}
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2.5 text-sm text-left text-foreground rounded-b-lg transition-colors cursor-pointer"
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor = `rgba(${color.rgb}, 0.1)`;
                        e.currentTarget.style.color = color.hex;
                      }}
