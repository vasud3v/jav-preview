    ...
    >
      <div className="heart-container" title={liked ? 'Unlike' : 'Like'}>
        <input
          ...
          aria-pressed={liked}
        />
        <div className="svg-container peer-focus-visible:ring-2 peer-focus-visible:ring-primary peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-background peer-focus-visible:rounded-full">
          <svg 
            viewBox="0 0 24 24" 
