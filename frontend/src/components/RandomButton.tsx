...
export default function RandomButton() {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={loading}
      className="fixed bottom-6 left-4 -translate-x-1/2 z-40 p-2.5 bg-transparent rounded-full transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer group flex items-center justify-center"
      style={{
        borderWidth: 1,
